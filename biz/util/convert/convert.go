...
func ToInterface(v interface{}, vType string) (interface{}, error) {
	switch vType {
	case "string":
		return ToAnyE[string](v)
	case "int64":
		return ToAnyE[int64](v)
	case "int32":
		return ToAnyE[int32](v)
	case "int":
		return ToAnyE[int](v)
	default:
		return v, fmt.Errorf("fieldType:[%s] unconfiged", vType)
	}
}
